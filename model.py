from layers import GraphConvolution, GraphConvolutionSparse, InnerProductDecoder,Fei_InnerProductDecoder,GraphConvolution_Chebyshev5
...
class GCNModelAE(Model):
    ...
    def _build(self):
        ...
        self.reconstructions,self.logits_output = Fei_InnerProductDecoder(input_dim=FLAGS.hidden2,
                                      act=lambda x: x,
...
class GCNModelVAE(Model):
    ...
    def _build(self):
        ...
        for i in range(10):
            ...
            self.z_log_std = self.z_log_std1 + self.z_mean
